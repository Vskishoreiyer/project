...
(function($) {
    ...
    $(document).ready(function($) {
        ...
        if (_popup_container.length > 0) {
            _popup_container.each(function(index) {
                var _this = jQuery(this);
                if (_this.find('a.portfolio-popup').length > 0) {
                    _this.magnificPopup({
                        type: 'image',
                ...
                if ($('a.portfolio-popup-single').length > 0) {
                    _popup_container.magnificPopup({
                        type: 'image',
                        delegate: 'a.portfolio-popup-single', // child items selector, by clicking on it popup will open
                        mainClass: 'mfp-with-zoom',
                        closeOnBgClick: true,
                        fixedContentPos: false,
                        callbacks: {
        ...
        if ($('.swiper-container-animation').length > 0) {
            ...
            $('.swiper-container-animation').each(function(index, value) {
                var _this = jQuery(this);
                var _div_id = 'swiper-container-animation-block-' + swipercount;
                _this.attr('id', _div_id);
                swipercount++;
                ...
                if (false === _autoplay) {
                    ...
                    var _autoplay_obj = {
                        delay: _this.attr('data-auto-speed') ? _this.attr('data-auto-speed') : 5000,
                        disableOnInteraction: _this.attr('data-disable-on-touch') ? _this.data('disable-on-touch') : false,
                    };
                }
        ...
        if (_instafeed.length > 0) {
            var _token = 'IGQVJWd09CZAy1xak13Mll4NkhuLWpMYjROQjVfMks0VGhUa3BxRFZAJV3NtVkI2bllfY2pKeUJEYVlaeTR3eHNnckN3RG9EYms2Mm1keVpwcmJKVlI1NlJhb3VtUUxVWXRicmlZAb3NueDhnYW95TVlBNAZDZD';
        ...
        $(document).on('submit', '#infinity_contact', function(e) {
            e.preventDefault();
